    ...
    <footer className="border-t border-border/70 bg-background py-12 text-muted-foreground">
      <div className="otw-container grid gap-8 md:grid-cols-2 lg:grid-cols-5">
        <div className="space-y-4 lg:col-span-2">
          <h4 className="text-lg font-semibold text-primary font-display">OTW</h4>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/cities" className="hover:text-primary transition-colors duration-300">Cities</Link></li>
          </ul>
        </div>
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/driver/apply" className="hover:text-primary transition-colors duration-300">Drive with Us</Link></li>
            <li><Link href="/franchise/apply" className="hover:text-primary transition-colors duration-300">Franchise</Link></li>
          </ul>
        </div>
        <div className="space-y-3">
