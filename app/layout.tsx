...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <html lang="en">
        <body className="min-h-screen bg-background text-foreground antialiased relative selection:bg-secondary/30 selection:text-secondary">
          {/* Global background effect */}
          <div className="fixed inset-0 z-[-1] pointer-events-none">
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-secondary/5 rounded-full blur-3xl opacity-20" />
