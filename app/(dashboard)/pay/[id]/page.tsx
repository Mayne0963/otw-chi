          ...
          <div className="space-y-5">
            ...
            {requiresDeliveryPayment ? (
                ...
                {deliveryFeeMilesRequired > 0 ? (
                  <div className="rounded-lg border border-otwGold/30 bg-otwGold/10 p-4">
                    <p className="text-sm text-white/85">
                      You can settle this delivery fee with your service miles instead of card payment.
                    </p>
                    <div className="mt-3">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-otwGold/30 bg-otwGold/10 p-4">
                  <p className="text-sm text-white/85">
                    You can settle this balance with your service miles instead of card payment.
                  </p>
                  <div className="mt-3">
                    <PayWithServiceMilesButton
                      deliveryRequestId={request.id}
