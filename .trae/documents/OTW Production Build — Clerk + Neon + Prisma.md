...
* **Enums**: `Role` (CUSTOMER, DRIVER, ADMIN, FRANCHISE), `RequestStatus` (DRAFT, SUBMITTED, ASSIGNED, PICKED\_UP, DELIVERED, COMPLETED, CANCELLED), `ServiceType` (FOOD, STORE, FRAGILE, CONCIERGE).
