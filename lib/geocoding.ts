...
const FEATURED_FORT_WAYNE_LOCATIONS: FeaturedLocation[] = [
  ...
  },
  {
    ...
    latitude: 41.1182,
    longitude: -85.1651,
    aliases: ['childrens zoo', 'zoo', 'fort wayne zoo', 'fw zoo'],
  },
  {
  ...
  {
    placeName: 'Buy Right Auto Sales',
    streetAddress: '1029 W Coliseum Blvd',
    city: 'Fort Wayne',
    state: 'IN',
    zipCode: '46808',
    latitude: 41.1176063,
    longitude: -85.1571087,
    aliases: ['buy right', 'buy right auto', 'used cars', 'car dealer', 'auto sales', 'west coliseum'],
  },
  {
    placeName: 'Glenbrook Dodge Chrysler Jeep Ram',
    streetAddress: '100 W Coliseum Blvd',
    city: 'Fort Wayne',
    state: 'IN',
    zipCode: '46805',
    latitude: 41.118339,
    longitude: -85.1410145,
    aliases: ['glenbrook dodge', 'dodge dealer', 'jeep dealer', 'ram dealer', 'car dealer', 'coliseum dealer'],
  },
  {
    placeName: 'Georgetown Entertainment',
    streetAddress: '6770 E State Blvd',
    city: 'Fort Wayne',
    state: 'IN',
    zipCode: '46815',
    latitude: 41.100628,
    longitude: -85.055864,
    aliases: ['georgetown bowl', 'bowling alley', 'arcade', 'locker room', 'east state'],
  },
  {
    placeName: "Piere's Entertainment Center",
    streetAddress: '5629 St Joe Rd',
    city: 'Fort Wayne',
    state: 'IN',
    zipCode: '46835',
    latitude: 41.131535,
    longitude: -85.102052,
    aliases: ['pieres', 'pieres entertainment', 'century music hall', 'concert venue', 'st joe road'],
  },
  {
